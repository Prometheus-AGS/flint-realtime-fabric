...
- [ ] **T1** Audit GQAdonis Iggy fork vs Apache upstream
...
- [ ] **T2** Create `crates/frf-broker-iggy/src/error.rs`
...
- [ ] **T3** Create `crates/frf-broker-iggy/src/channel.rs`
...
- [ ] **T4** Create `crates/frf-broker-iggy/src/broker.rs`
...
- [ ] **T7** Write integration test (requires local Iggy instance)
