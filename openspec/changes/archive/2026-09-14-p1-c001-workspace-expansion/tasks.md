...
- [x] **T1** Add new workspace members to root `Cargo.toml`
  - File: `Cargo.toml`
...
- [x] **T2** Add shared dependencies to `[workspace.dependencies]`
  - File: `Cargo.toml`
...
- [x] **T3** Create stub `crates/frf-app/Cargo.toml` + `src/lib.rs`
...
- [x] **T4** Create stub `crates/frf-broker-iggy/Cargo.toml` + `src/lib.rs`
...
- [x] **T5** Create stub `crates/frf-authz-keto/Cargo.toml` + `src/lib.rs`
...
- [x] **T6** Create stub `crates/frf-identity-ory/Cargo.toml` + `src/lib.rs`
...
- [x] **T7** Create stub `crates/frf-postgres-cdc/Cargo.toml` + `src/lib.rs`
...
- [x] **T8** Verify full workspace compiles
