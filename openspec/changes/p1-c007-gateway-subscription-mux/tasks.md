...
- [ ] **T1** Create `crates/frf-gateway/src/config.rs`
...
- [ ] **T2** Create `crates/frf-gateway/src/error.rs`
...
- [ ] **T5** Create `crates/frf-gateway/src/routes/publish.rs`
...
- [ ] **T6** Update `crates/frf-gateway/src/main.rs`
...
- [ ] **T7** Create `crates/frf-gateway/src/routes/mod.rs`
  - `pub mod health; pub mod publish; pub mod subscribe;`
  - Verification: `cargo check -p frf-gateway` exits 0

- [ ] **T8** Write integration smoke test
...
- [ ] **T9** Verify full workspace compiles and CI gates pass
